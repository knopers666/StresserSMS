...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5383c064d02bd5_01933220',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5383c064d02bd5_01933220')) {function content_5383c064d02bd5_01933220($_smarty_tpl) {?><!DOCTYPE html>
<html lang="pl">
  <head>
	<!-- Meta Tagi -->
    <meta charset="utf-8">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="disabled"><a href="#">PL</a></li>
						<li class="disabled"><a href="#">ENG</a></li>
					</ul>
				</li>
			</ul>
        </div><!--/.nav-collapse -->
	...
	<section id="contact" class="row">
		<div class="col-md-12">
			<div class="box">
				...
				<address>
					<strong>Email:</strong> kontakt@go2ddos.pl
				</adress>
			</div>
		</div>
	</section>
